...
/**
 * @GenthzSource is an {@linkplain ArgumentsSource} which provides access to values returned by {@linkplain #objectFactory()}.
 ...
 *      public String instance(InstanceContext<T> context) {
 *          return "String value";
 *      }
 * }
 * </pre>
