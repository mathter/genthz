...
import org.genthz.loly.test.TestEnum;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;

public class EnumInstanceBuilderTest {
    @Test
    public void test() {
        final ObjectFactory factory = ObjectFactoryProducer.producer().factory(new DefaultConfiguration());

        TestEnum value = factory.build(TestEnum.class);

        Assertions.assertTrue(value instanceof TestEnum);
    }
}
